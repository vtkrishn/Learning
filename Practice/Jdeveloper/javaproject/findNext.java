...
public class findNext {
   ...
   public static int firstMissingPositive(List<Integer> a) {
         ...
         if(sum == total)
           ...
           //return (max-min) > 1 ? (min == 1 ? min+1 : 1) : max+1;
